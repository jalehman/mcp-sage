      ...
      lines.forEach(line => {
        ...
        try {
          ...
          if (response.id === 1 && response.result) {
            console.log('Sending sage-plan tool request...');
          ...
          if (response.method && response.method.startsWith("notifications/")) {
            console.log(`Notification: ${response.params.level} - ${response.params.data}`);
          }
          ...
          if (response.id === 2) {
            ...
            if (response.result && response.result.content) {
              ...
              if (response.result.content.length > 1) {
                ...
                console.log("==========================");
                console.log(response.result.content[1].text.substring(0, 200) + "...");
              }
